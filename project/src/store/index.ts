...
// Когда мы будем описывать ассинхронные действия, у нас у action 3м параметром extraArgument передаем настроенный экзампляр axios (api), соответсвенно actions смогут обращаться к axios  и выполнять какие-то действия
